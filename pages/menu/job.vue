<template>
	<view class="uni-flex uni-column list">
		...
		<HMfilterDropdown :filterData="filterData" :defaultSelected ="defaultSelected"  @confirm="confirm">
		</HMfilterDropdown>
				...
				<swiper class="xll-ads-swiper" :indicator-dots="false" :autoplay="true" :interval="4000"
					...
					<swiper-item v-for="(item,index) in jobsAdsListBottom" :key="index">
						<view class="swiper-item">
							<image @click="showContactStatus=true" :src="item.url" mode="scaleToFit" lazy-load="true">
							</image>
						</view>
					</swiper-item>
				</swiper>
