	...
	export default {
		...
		methods: {
			turnVendorProfile(userId) {
				...
				let turn_url = origin + '/esl_h5/pagesB/me/vendor/share?id=' + userId + '&type=deals';
				window.location.href = turn_url;
				// #endif
				
				// #ifndef H5
				uni.navigateTo({
					url:'/pagesB/me/vendor/share?id=' + userId + '&type=deals'
				})
				// #endif
			...
			turnDetail(id) {
				...
				var url = window.location.href;
				var origin = window.location.origin;
				let turn_url = origin + '/esl_h5/pagesB/me/deals/detail?id=' + id + '&source=1';
				window.location.href = turn_url;
				// #endif
				
				// #ifndef H5
				uni.navigateTo({
					url:'/pagesB/me/deals/detail?id=' + id + '&source=1'
				})
				// #endif
