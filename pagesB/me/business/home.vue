	...
	export default {
		...
		methods: {
			...
			turnEditBusinessSchool() {
				...
				let turn_url = origin + '/esl_h5/pagesB/me/business/edit/school';
			...
			turnEditBusinessBasic() {
				...
				// var url = window.location.href;
				// var origin = window.location.origin;
				// let turn_url = origin + '/esl_h5/pagesB/me/business/edit/businessBasic';
				// window.location.href = turn_url;
			},
			turnEditOurJobs() {
				uni.navigateTo({
		...
		onShareAppMessage:function(){
			...
			return {
				...
				path:'/pagesB/me/business/share?id='+uid
			}
		},
