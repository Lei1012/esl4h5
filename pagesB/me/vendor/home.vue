				...
				<view class="basic-info" v-if="current===2">
					<view class="basic-info-t">
						...
						<view class="edit-icon" @click="turnEditYourBasic">
							<image src="/pagesB/static/esl/edit.png" mode="aspectFit"></image>
						</view>
					</view>
					<view class="basic-info-b">
	...
	export default {
			...
			getBasicInfo() {
				...
				profile.getBasicInfo(data).then(res => {
					...
					if (res.code == 200) {
						...
						let turn_url = origin + '/esl_h5/pagesB/me/vendor/share?id=' + user_id;
		...
		onShareAppMessage:function(){
			...
			return {
				...
				path:'/pagesB/me/vendor/share?id='+uid
			}
		},
