		...
		<view class="simple-address-content simple-address--fixed" :class="[type, ani + '-content', animation ? 'content-ani' : '']">
			<view class="simple-address__header">
				<view class="simple-address__header-btn-box" @click="pickerCancel">
					<text class="simple-address__header-text" :style="{ color: cancelColor, fontSize: btnFontSize }">Cancel</text>
				</view>
				<view class="simple-address__header-btn-box" @click="pickerConfirm">
					<text class="simple-address__header-text" :style="{ color: confirmColor || themeColor, fontSize: btnFontSize }">Confirm</text>
				</view>
			</view>
...
// import provinceData from './city-data/provinceEn.js';
// import cityData from './city-data/cityEn.js';
// import areaData from './city-data/areaEn.js';
export default {
	name: 'simpleAddress',
	props: {
		mode: {
